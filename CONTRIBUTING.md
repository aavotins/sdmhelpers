...
This outlines how to propose a change to sdmhelpers. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("aavotins/sdmhelpers", fork = TRUE)`.
...
Please note that the sdmhelpers project is released with a [Contributor
Code of
Conduct](https://aavotins.github.io/sdmhelpers/CODE_OF_CONDUCT.md). By
